...
<!-- show event of logged in organizer -->
                <?php
                    ...
                    <tr>
                        ...
                        <td><?php
                            if($row['campaign_status']==2)  {
                                echo "<span id='waiting'>Failed</span>";
                            }
                            elseif($row['campaign_status']==0)  {
                                echo "<span id='approved'>Waiting</span>";
                            }
                            else {
                                echo "<span id='approved'>Success</span>";
                            }
                        ?></td>
                    </tr>
                </table><br><br>
